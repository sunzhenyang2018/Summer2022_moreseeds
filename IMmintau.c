...
#define mmin mmin_IM
 double mmin = 7;
#define mtau_IM _thread1data[0]
#define mtau _thread[_gth]._pval[0]
#define minf_IM _thread1data[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 IM C:/Users/user/PycharmProjects/Summer2022/IMmintau.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
 minf = 1.0 / ( 1.0 + exp ( - ( _lv + 27.0 ) / 7.0 ) ) ;
   _la = c1 / exp ( - ( _lv - vhalf1 ) / k1 ) ;
   _lb = c2 / exp ( ( _lv - vhalf2 ) / k2 ) ;
   mtau = 1.0 / ( _la + _lb ) ;
   if ( mtau < mmin ) {
     mtau = mmin ;
     }
...
#if NMODL_TEXT
static const char* nmodl_filename = "IMmintau.mod";
static const char* nmodl_file_text = 
  "UNITS {\n"
  "        (mA) = (milliamp)\n"
  "        (mV) = (millivolt)\n"
